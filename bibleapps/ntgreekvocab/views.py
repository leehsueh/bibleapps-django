import bibleapps.ntgreekvocab.models
...
from bibleapps.ntgreekvocab.forms import SimpleCardAdminForm
from bibleapps.ntgreekvocab import greek
...
def card_list(request):
    ...
    parts_of_speech = [(short,long) for short, long in bibleapps.ntgreekvocab.models.PARTS_OF_SPEECH_MAP.items()]
    context = {
